...
export default function TelegramAdmins() {
  ...
  return (
    <div className="space-y-8" data-testid="telegram-admins-page">
      ...
      >
        <div>
          <h1 className="font-serif text-4xl font-semibold tracking-tight text-white">Telegram Admins</h1>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg ${
                      admin.is_active ? "bg-gradient-to-br from-lime-500 to-emerald-600" : "bg-muted"
                    }`}>
