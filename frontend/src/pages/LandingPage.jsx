...
const benefits = [
  { icon: Wallet, title: "Earn with Subscriptions", desc: "Set up weekly, monthly, or yearly plans. Auto-collect payments. Auto-grant channel access. Zero manual work.", color: "#E11D48", span: "md:col-span-2" },
  ...
  { icon: Radio, title: "Run Paid Live Sessions", desc: "Go live with ticket-based access. VIP rooms. Real-time super chats. Replays for premium members.", color: "#E11D48", span: "md:col-span-2" },
];
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden" style={{ background: "hsl(340,50%,4%)", fontFamily: "Manrope, sans-serif" }}>
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-28">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-[#E11D48]/15 border border-[#E11D48]/30 rounded-full px-4 py-1.5 mb-6">
              <Zap className="w-4 h-4 text-[#E11D48]" />
              <span className="text-xs font-bold uppercase tracking-widest text-[#E11D48]">#1 Telegram Monetization Platform</span>
            </motion.div>
            <motion.h1 variants={fadeUp} style={{ fontFamily: "Unbounded" }} className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] mb-6">
              ...
              <span className="bg-gradient-to-r from-[#E11D48] via-[#F43F5E] to-[#FB7185] bg-clip-text text-transparent">Income</span>
            </motion.h1>
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              <button onClick={() => navigate("/login")} className="flex items-center gap-2 bg-[#E11D48] hover:bg-[#BE123C] text-white font-bold rounded-full px-8 py-4 text-lg shadow-[0_0_30px_rgba(225,29,72,0.4)] transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(225,29,72,0.6)]" data-testid="hero-cta-start">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.3 }} className="relative">
            <div className="absolute -inset-4 bg-[#E11D48]/10 rounded-3xl blur-3xl" />
              ...
              <div className="h-32 mb-6">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={chartData}>
                    ...
                    <Area type="monotone" dataKey="v" stroke="#E11D48" fill="url(#heroGrad)" strokeWidth={2.5} dot={false} />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
              <div className="grid grid-cols-3 gap-3">
                {[
                  { label: "Active Subs", val: "2,847", color: "#E11D48" },
      ...
      <section id="benefits" className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-16">
            <motion.p variants={fadeUp} className="text-sm uppercase tracking-[0.2em] font-bold text-[#E11D48] mb-3">Why Creators Love Us</motion.p>
            <motion.h2 variants={fadeUp} style={{ fontFamily: "Unbounded" }} className="text-3xl md:text-5xl font-bold tracking-tight">
              Everything You Need to<br /><span className="bg-gradient-to-r from-[#E11D48] to-[#FB7185] bg-clip-text text-transparent">Monetize Your Audience</span>
            </motion.h2>
          </motion.div>
      ...
      <section className="py-24 md:py-32 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#E11D48]/5 via-transparent to-transparent" />
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-16">
            <motion.p variants={fadeUp} className="text-sm uppercase tracking-[0.2em] font-bold text-[#E11D48] mb-3">Killer Feature</motion.p>
            <motion.h2 variants={fadeUp} style={{ fontFamily: "Unbounded" }} className="text-3xl md:text-5xl font-bold tracking-tight mb-4">
              Go Live & Earn<br /><span className="bg-gradient-to-r from-[#E11D48] to-[#FB7185] bg-clip-text text-transparent">Instantly</span>
            </motion.h2>
              ...
              <div className="h-[520px] relative">
                ...
                <div className="h-full bg-gradient-to-br from-[#1a0510] via-[#0A0305] to-[#150308] flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-r from-[#E11D48] to-[#FB7185] flex items-center justify-center mx-auto mb-3 shadow-[0_0_40px_rgba(225,29,72,0.5)]">
      ...
      <section className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-16">
            <motion.p variants={fadeUp} className="text-sm uppercase tracking-[0.2em] font-bold text-[#E11D48] mb-3">Real Results</motion.p>
            <motion.h2 variants={fadeUp} style={{ fontFamily: "Unbounded" }} className="text-3xl md:text-5xl font-bold tracking-tight">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-[#0A0305] border border-white/10 rounded-2xl p-6 hover:border-[#E11D48]/30 transition-all" data-testid={`testimonial-${i}`}>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#E11D48] to-[#FB7185] flex items-center justify-center text-sm font-bold">{t.avatar}</div>
                    <div>
      ...
      <section id="how" className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-20">
            <motion.p variants={fadeUp} className="text-sm uppercase tracking-[0.2em] font-bold text-[#E11D48] mb-3">Simple Setup</motion.p>
            <motion.h2 variants={fadeUp} style={{ fontFamily: "Unbounded" }} className="text-3xl md:text-5xl font-bold tracking-tight">
              Start in <span className="bg-gradient-to-r from-[#E11D48] to-[#FB7185] bg-clip-text text-transparent">3 Steps</span>
            </motion.h2>
          </motion.div>
            ...
            {steps.map((s, i) => (
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="relative text-center group">
                ...
                <div className="relative pt-12">
                  <div className="w-16 h-16 rounded-2xl bg-[#E11D48]/15 border border-[#E11D48]/30 flex items-center justify-center mx-auto mb-6 group-hover:bg-[#E11D48]/25 transition-all">
                    {i === 0 && <Send className="w-7 h-7 text-[#E11D48]" />}
                    {i === 1 && <Crown className="w-7 h-7 text-[#E11D48]" />}
                    {i === 2 && <Wallet className="w-7 h-7 text-[#E11D48]" />}
                  </div>
      ...
      <section id="pricing" className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-16">
            <motion.p variants={fadeUp} className="text-sm uppercase tracking-[0.2em] font-bold text-[#E11D48] mb-3">Pricing</motion.p>
            <motion.h2 variants={fadeUp} style={{ fontFamily: "Unbounded" }} className="text-3xl md:text-5xl font-bold tracking-tight">
              Invest in Your <span className="bg-gradient-to-r from-[#E11D48] to-[#FB7185] bg-clip-text text-transparent">Growth</span>
            </motion.h2>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-r from-[#E11D48]/10 to-transparent border border-[#E11D48]/20 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <Gift className="w-5 h-5 text-[#E11D48]" />
                <span className="text-sm font-bold text-[#E11D48] uppercase tracking-wider">Referral Program</span>
              </div>
            ...
            <button onClick={() => navigate("/login")} className="bg-[#E11D48] hover:bg-[#BE123C] text-white font-bold rounded-full px-8 py-3 shadow-[0_0_20px_rgba(225,29,72,0.3)] transition-all hover:scale-105 flex-shrink-0" data-testid="referral-cta">
      ...
      {/* FINAL CTA */}
      <section className="py-24 md:py-32 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-t from-[#E11D48]/10 via-transparent to-transparent" />
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center relative">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            <motion.h2 variants={fadeUp} style={{ fontFamily: "Unbounded" }} className="text-4xl md:text-6xl font-black tracking-tight mb-6">
              Start Monetizing<br /><span className="bg-gradient-to-r from-[#E11D48] via-[#F43F5E] to-[#FB7185] bg-clip-text text-transparent">Today</span>
            </motion.h2>
            ...
            <motion.div variants={fadeUp}>
              <button onClick={() => navigate("/login")} className="relative bg-[#E11D48] hover:bg-[#BE123C] text-white font-bold rounded-full px-12 py-5 text-xl shadow-[0_0_40px_rgba(225,29,72,0.5)] transition-all hover:scale-105 hover:shadow-[0_0_60px_rgba(225,29,72,0.7)]" data-testid="final-cta">
                <span className="absolute inset-0 rounded-full animate-ping bg-[#E11D48]/30" style={{ animationDuration: "2s" }} />
