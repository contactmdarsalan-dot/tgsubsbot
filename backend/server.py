...
from config import (
    logger, JWT_SECRET, TELEGRAM_BOT_TOKEN, TELEGRAM_CHANNEL_ID,
    EMERGENT_LLM_KEY, RAZORPAY_KEY_ID, RAZORPAY_KEY_SECRET,
    TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, TWILIO_PHONE_NUMBER,
    DASHBOARD_PLANS, razorpay_client, twilio_client, ROOT_DIR
)
from database import db, client as mongo_client, cache_get, cache_set, cache_delete
from models import (
    UserCreate, UserLogin, User, SubscriptionPlanCreate, SubscriptionPlan,
    SubscriberCreate, Subscriber, PaymentCreate, Payment, BotSettings,
    MessageTemplate, Coupon, UserNote, UserTag, Creator, Referral,
    ScheduledBroadcast, FAQ, BlockedUser, VideoCallBooking, SupportTicket,
...
# Configure logging (imported from config)
# logger is imported from config module

# ============== MODELS (imported from models/) ==============
# All models now defined in /app/backend/models/__init__.py

# Dashboard subscription plans (imported from config)
# DASHBOARD_PLANS defined in config.py
