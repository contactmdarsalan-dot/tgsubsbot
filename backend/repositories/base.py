...
# Additional repos for dashboard/engagement collections
channels_repo = TenantScopedRepository("channels")
chat_groups_repo = TenantScopedRepository("chat_groups_pool")
chat_sessions_repo = TenantScopedRepository("chat_sessions")
templates_repo = TenantScopedRepository("templates")
scheduled_broadcasts_repo = TenantScopedRepository("scheduled_broadcasts")
user_notes_repo = TenantScopedRepository("user_notes")
user_tags_repo = TenantScopedRepository("user_tags")
blocked_users_repo = TenantScopedRepository("blocked_users")
faqs_repo = TenantScopedRepository("faqs")
video_call_bookings_repo = TenantScopedRepository("video_call_bookings")
